...
public class WiltedWheatCropBlock extends WiltedCropBlock {
    public final int[] age_shape_heights;
    public static IntProperty AGE = Properties.AGE_7;

    public WiltedWheatCropBlock(Settings settings, int[] age_shape_heights) {
        super(settings, age_shape_heights);
